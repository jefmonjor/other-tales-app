...
abstract class AppLocalizations {
  ...
  /// No description provided for @dashboardImages.
  ///
  /// In en, this message translates to:
  /// **'Images'**
  String get dashboardImages;

  /// No description provided for @dashboardIdeas.
  ///
  /// In en, this message translates to:
  /// **'Ideas'**
  String get dashboardIdeas;

  /// No description provided for @dashboardStory.
  ///
  /// In en, this message translates to:
  /// **'Story'**
  String get dashboardStory;

  /// No description provided for @dashboardCharacters.
  ///
  /// In en, this message translates to:
  /// **'Characters'**
  String get dashboardCharacters;
